...
% Simulation = 'GaussianMod1';
% Simulation = 'GaussianMod2';
% Simulation = 'GaussianMod3';

% Simulation = 'GaussianExp1';
% Simulation = 'GaussianExp2';
% Simulation = 'GaussianExp3';
...
elseif strcmp(Simulation,'GaussianMod1')
    eval('SetGaussian2Modified1');
elseif strcmp(Simulation,'GaussianMod2')
    eval('SetGaussian2Modified2');
elseif strcmp(Simulation,'GaussianMod3')
    eval('SetGaussian2Modified3');
elseif strcmp(Simulation,'GaussianExp1')
    eval('SetGaussian2Exponential1');
elseif strcmp(Simulation,'GaussianExp2')
    eval('SetGaussian2Exponential2');
elseif strcmp(Simulation,'GaussianExp3')
    eval('SetGaussian2Exponential3');
...
elseif strcmp(Simulation,'PNJctEqMod')
    eval('SetPNJctParasEqBCBiasModified');
end
